        ...
        <div className="frappe-card" style={{ maxWidth: 1200, margin: "0 auto", padding: 25 }}>
            ...
            <form onSubmit={state.handleSave}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "30px" }}>
                    ...
                    <button type="button" className="btn btn-secondary" onClick={() => state.addRow(state.setZones, { zone_code: "", zone_name: "", states_raw: "", rate_per_kg: "" })}>+ Add Zone Rate</button>
                </div>
                    ...
                    <tbody>
                        {state.zones.map((z, i) => (
                            <tr key={i}>
                                ...
                                <td><button type="button" className="btn-text-danger" onClick={() => state.removeRow(state.zones, state.setZones, i)}>✕</button></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "30px" }}>
                    ...
                    <button type="button" className="btn btn-secondary" onClick={() => state.addRow(state.setFuelMatrix, { fuel_price_from: "", fuel_price_to: "", surcharge_percentage: "" })}>+ Add Fuel Slab</button>
                </div>
                <table style={{ width: "100%", marginBottom: "20px" }}>
                    <thead>
                    ...
                    <tbody>
                        {state.fuelMatrix.map((f, i) => (
                            <tr key={i}>
                                ...
                                <td><button type="button" className="btn-text-danger" onClick={() => state.removeRow(state.fuelMatrix, state.setFuelMatrix, i)}>✕</button></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "1px solid var(--border-light)", paddingTop: "20px", marginTop: "20px" }}>
                    <div>
                        {state.selectedPartnerId && (
                            <button type="button"  className="btn"  style={{ padding: "12px 30px", fontSize: "16px", fontWeight: "bold", background: "var(--brand-danger, #dc3545)", color: "#fff", border: "none" }} onClick={state.handleDelete} disabled={state.isDeleting}>
