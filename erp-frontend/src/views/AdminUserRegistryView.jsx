...
export default function AdminUserRegistryView({ state }) {
    const [form, setForm] = useState({ 
        email: '', name: '', password: '', role: '', dob: '', phone_personal: '', phone_business: '', regions: [] 
    });
    
    // Extracted and alphabetized from your team classification
        ...
        <div className="frappe-card">
            ...
            <form onSubmit={handleRegister} className="form-grid-layout" style={{ background: 'var(--bg-main)', padding: '20px', borderRadius: 'var(--radius-sm)', border: '1px solid var(--border-light)' }}>
                ...
                <div className="form-group">
                    ...
                    <input type="text" required className="form-input" value={form.password} onChange={e => setForm({...form, password: e.target.value})} />
                </div>
                <div className="form-group">
                    ...
                    <select required className="form-select-native" value={form.role} onChange={e => setForm({...form, role: e.target.value})}>
                        ...
                        <option value="Transport">Dispatch Engineer</option>
                ...
                <div className="form-group grid-span-2">
                    <label className="input-label">Assigned Operational Regions & Territories</label>
