...
export default function useDispatchPlanner({sessionToken, showErrorModal, addToast}) {
    ...
    const [dim, setDim] = useState({weight: 0, invoice_value: 0, destination_city: "", fuel_price: 100, loading_type: "local", hub_loading_input: 0, delivery_type: "door", hamali_detail: "", hamali_cost: 0});
