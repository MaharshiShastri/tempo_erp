...
@router.get("/purchase-ledger", dependencies=[Depends(check_department("Shop Floor Administrator"))])
def get_purchase_ledger(user=Depends(verify_bearer_token)):
    return EDBR.get_purchase_ledger()
